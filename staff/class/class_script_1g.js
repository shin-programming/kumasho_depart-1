...
window.addEventListener('DOMContentLoaded', async function () {
    ...
    // GET用（初期データ取得）
    const gas_url = "https://script.google.com/macros/s/AKfycbxbLB9n0R4aWXw9ZSSH0zt3jPkEaKwXmXtfQB4WJAqOClEQA3AzWexMmoyU8GTd2CVxKg/exec?sheet=" + encodeURIComponent(className);
    // POST用（販売状況更新）
    const gas_post_url = "https://script.google.com/macros/s/AKfycbxbLB9n0R4aWXw9ZSSH0zt3jPkEaKwXmXtfQB4WJAqOClEQA3AzWexMmoyU8GTd2CVxKg/exec";
